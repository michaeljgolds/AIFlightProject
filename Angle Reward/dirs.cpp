...
Dirs::Dirs (char *arg)
    ...
    */
    ...
    display("Dirs::Dirs() myfile = ",LOG_MOST);
...
found:
    ...
    if (env != NULL)
        {
        display("Dirs::Dirs() 160408aa", LOG_MOST);
        strcpy (textures, env);
        strcpy (music, env);
        strcpy (sound, env);
        strcpy (models, env);
        ...
        {
        sprintf (buf, "Found LAC data directory %s ", myfile);
    ...
    display("Dirs::Dirs() 160408ab", LOG_MOST);
...
char *Dirs::getTextures (char *name)
    ...
    strcpy (dir, "../textures/");
    strcat (dir, name);
    display ("Dirs::getTextures() seeking from ", LOG_MOST);
...
char *Dirs::getMusic (char *name)
    ...
    strcpy (dir, "../music/");
    strcat (dir, name);
    display ("Dirs::getMusic() seeking from ", LOG_MOST);
    display (dir, LOG_MOST);
    return dir;
    }
...
char *Dirs::getSounds (char *name)
    ...
    strcpy (dir, "../sounds/");
    strcat (dir, name);
    display ("Dirs::getSounds() seeking from ", LOG_MOST);
    display (dir, LOG_MOST);
    return dir;
    }
...
char *Dirs::getModels (char *name)
    ...
    strcpy (dir, "../models/");
    strcat (dir, name);
    display ("Dirs::getModels() seeking from ", LOG_MOST);
    display (dir, LOG_MOST);
    return dir;
    }

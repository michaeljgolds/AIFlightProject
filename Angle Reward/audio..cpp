...
SoundSystem::SoundSystem ()
    ...
    music1 = Mix_LoadMUS (dirs->getMusic ("Music00.wav"));
    if (music1 == NULL)
        {
...
void SoundSystem::play (int sample, bool loop)
    ...
    switch (sample)
        ...
        case SOUND_ENEMYHQACKACKFROM01TO10PCT:
            EnemyHqAckAckFrom01to10Pct->play (7, loop);
            break;
        case SOUND_ENEMYHQACKACKFROM10TO20PCT:
            EnemyHqAckAckFrom10to20Pct->play (7, loop);
            break;
        case SOUND_ENEMYHQACKACKFROM20TO30PCT:
            EnemyHqAckAckFrom20to30Pct->play (7, loop);
            break;
        case SOUND_ENEMYHQACKACKFROM30TO40PCT:
            EnemyHqAckAckFrom30to40Pct->play (7, loop);
            break;
        case SOUND_ENEMYHQACKACKFROM40TO50PCT:
            EnemyHqAckAckFrom40to50Pct->play (7, loop);
            break;
        case SOUND_ENEMYHQACKACKFROM50TO60PCT:
            EnemyHqAckAckFrom50to60Pct->play (7, loop);
            break;
        case SOUND_ENEMYHQACKACKFROM60TO70PCT:
            EnemyHqAckAckFrom60to70Pct->play (7, loop);
            break;
        case SOUND_ENEMYHQACKACKFROM70TO80PCT:
            EnemyHqAckAckFrom70to80Pct->play (7, loop);
            break;
        case SOUND_ENEMYHQACKACKFROM80TO90PCT:
            EnemyHqAckAckFrom80to90Pct->play (7, loop);
            break;
        case SOUND_ENEMYHQACKACKFROM90TO100PCT:
            EnemyHqAckAckFrom90to100Pct->play (7, loop);
            break;
        case SOUND_ENEMYHQREPAIRSPROCEEDINGNORMALLY:
            EnemyHqRepairsProceedingNormally->play (7, loop);
            break;
        case SOUND_ENEMYHQREPAIRSPROCEEDINGRAPIDLY:
            EnemyHqRepairsProceedingRapidly->play (7, loop);
            break;
        case SOUND_ENEMYHQREPAIRSSTOPPED:
            EnemyHqRepairsStopped->play (7, loop);
            break;
        ...
        case SOUND_MISSIONENDINGINSTRUMENTAL:
            waveMissionEndingInstrumental->play (5, loop); 
            break;
...
void SoundSystem::loadMusic (int sample)
    ...
    switch (sample)
        ...
        case MUSIC_ANDCOMBAT:
            music1 = Mix_LoadMUS (dirs->getMusic ("MusicAndCombat00.wav"));
            break;
        case MUSIC_TUTORIAL01:
            display ("SoundSystem::loadMusic() loading MUSIC_TUTORIAL01", LOG_MOST);
            music1 = Mix_LoadMUS (dirs->getMusic ("MusicTutorial1.wav"));
            break;
        case MUSIC_TUTORIAL02:
            display ("SoundSystem::loadMusic() loading MUSIC_TUTORIAL02", LOG_MOST);
            music1 = Mix_LoadMUS (dirs->getMusic ("MusicTutorial2.wav"));
            break;
        case MUSIC_TUTORIAL03:
            display ("SoundSystem::loadMusic() loading MUSIC_TUTORIAL03", LOG_MOST);
            music1 = Mix_LoadMUS (dirs->getMusic ("MusicTutorial3.wav"));
            break;
        case MUSIC_TUTORIAL04:
            display ("SoundSystem::loadMusic() loading MUSIC_TUTORIAL04", LOG_MOST);
            music1 = Mix_LoadMUS (dirs->getMusic ("MusicTutorial4.wav"));
            break;
        case MUSIC_TURKEYSHOOT:
            display ("SoundSystem::loadMusic() loading MUSIC_TURKEYSHOOT", LOG_MOST);
            music1 = Mix_LoadMUS (dirs->getMusic ("MusicTurkeyShoot.wav"));
            break;
        case MUSIC_EVERYMANFORHIMSELF:
            display ("SoundSystem::loadMusic() loading MUSIC_EVERYMANFORHIMSELF", LOG_MOST);
            music1 = Mix_LoadMUS (dirs->getMusic ("MusicEveryManForHimself.wav"));
            break;
        case MUSIC_TEAMSMISSILESANDGUNS:
            display ("SoundSystem::loadMusic() loading MUSIC_TEAMSMISSILESANDGUNS", LOG_MOST);
            music1 = Mix_LoadMUS (dirs->getMusic ("MusicTeamsMissilesAndGuns.wav"));
            break;
        case MUSIC_MISSIONNETWORKBATTLE01:
            display ("SoundSystem::loadMusic() loading MUSIC_MISSIONNETWORKBATTLE01", LOG_MOST);
            music1 = Mix_LoadMUS (dirs->getMusic ("MusicMissionNetworkBattle01.wav"));
            break;
        case MUSIC_MISSIONNETWORKBATTLE02:
            display ("SoundSystem::loadMusic() loading MUSIC_MISSIONNETWORKBATTLE02", LOG_MOST);
            music1 = Mix_LoadMUS (dirs->getMusic ("MusicMissionNetworkBattle02.wav"));
            break;
        case MUSIC_MISSIONNETWORKBATTLE03:
            display ("SoundSystem::loadMusic() loading MUSIC_MISSIONNETWORKBATTLE03", LOG_MOST);
            music1 = Mix_LoadMUS (dirs->getMusic ("MusicMissionNetworkBattle03.wav"));
            break;
        case MUSIC_TEAMBASE:
            display ("SoundSystem::loadMusic() loading MUSIC_TEAMBASE", LOG_MOST);
            music1 = Mix_LoadMUS (dirs->getMusic ("MusicTeamBase1.wav"));
            break;
        case MUSIC_WAVES1:
            display ("SoundSystem::loadMusic() loading MUSIC_WAVES1", LOG_MOST);
            music1 = Mix_LoadMUS (dirs->getMusic ("MusicWaves1.wav"));
            break;
        case MUSIC_JETBAIT:
            display ("SoundSystem::loadMusic() loading MUSIC_JETBAIT", LOG_MOST);
            music1 = Mix_LoadMUS (dirs->getMusic ("MusicJetBait1.wav"));
            break;
        case MUSIC_FREEFLIGHTWW2:
            display ("SoundSystem::loadMusic() loading MUSIC_FREEFLIGHTWW2", LOG_MOST);
            music1 = Mix_LoadMUS (dirs->getMusic ("MusicFreeFlightWw2.wav"));
            break;
        case MUSIC_HEADTOHEAD:
            display ("SoundSystem::loadMusic() loading MUSIC_HEADTOHEAD", LOG_MOST);
            music1 = Mix_LoadMUS (dirs->getMusic ("MusicHeadToHead00.wav"));
            break;
        case MUSIC_MUSIC01:
            music1 = Mix_LoadMUS (dirs->getMusic ("Music00.wav"));
            break;
        case MUSIC_MUSIC02:
            music1 = Mix_LoadMUS (dirs->getMusic ("Music01.wav"));
            break;
        case MUSIC_MUSIC03:
            music1 = Mix_LoadMUS (dirs->getMusic ("Music02.wav"));
            break;
        case MUSIC_MUSIC02ANDFURBALLAA:
            music1 = Mix_LoadMUS (dirs->getMusic ("Music02AndFurballAA.wav"));
            break;
        }
    } 

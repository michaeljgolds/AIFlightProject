...
void GLLandscape::precalculate ()
    ...
    float a[3];
    float c[3];
    display ("GLLandscape::precalculate()", LOG_MOST);
...
GLLandscape::GLLandscape (Space *space2, int type, int *heightmask)
    ...
    int i, i2;
    display ("GLLandscape::GLLandscape()", LOG_MOST);
    lsticker = 0;
    space = space2;
    randptr = 0;
    if (
   ...
   display ("Saving height map in file LastTerrain.LAC", LOG_MOST);
   TerrainFile = fopen ("LastTerrain.LAC", "wb"); 
   if (TerrainFile == NULL)
      { 
      display ("GLLandscape::GLLandscape() failed to open LastTerrain.LAC", LOG_MOST);
      return;
      }
   else
      {
      display ("GLLandscape::GLLandscape() succesfully opened LastTerrain.LAC", LOG_MOST);
      }
   ...
   display ("GLLandscape::GLLandscape() Wrote new version of LastTerrain.LAC", LOG_MOST);
    } 
#endif
